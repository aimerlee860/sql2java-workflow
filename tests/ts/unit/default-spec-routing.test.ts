 ...
 *
 * Phase 2 退役 PROJECT_SPEC_MAP 后，7 个 translation-specs 子规约改由默认主 spec 的
...
describe("默认 spec @include 路由（PROJECT_SPEC_MAP 退役后）", () => {
  ...
  it("路由型子规约不内联进 general 正文", () => {
    // general 不应含 translation-specs 的专属内容标记（如 skeleton 的段切分章节标题）
    expect(bundle.general).not.toContain("@include ./translation-specs/skeleton.md -> translate-skeleton")
  })
